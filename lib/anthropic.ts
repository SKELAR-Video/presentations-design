...
2. Текст зберігати ДОСЛІВНО і ПОВНІСТЮ — жодних переформулювань, скорочень, перекладів.
   max_chars — ІГНОРУЙ. Вставляй весь текст у слот навіть якщо він довший за ліміт.
...
6. Ігноруй image-слоти. flags завжди {}.

## Як розподілити текст слайду по слотах
- Перший/найбільший текстовий блок — зазвичай ЗАГОЛОВОК.
- Якщо є кілька рівнозначних текстів — розподіли по колонках (two_columns / three_columns / bento_right_2 / bento_right_3).
