...
- agenda_6 → слайд адженди або порядку денного з РІВНО 6 пунктами (timeline: 3 колонки × 2 рядки). ЗАГОЛОВОК = "Адженда". ПУНКТ_1..ПУНКТ_6 = стислий текст кожного пункту (≤80 символів). Ніколи не використовуй agenda_6 якщо пунктів не рівно 6.
...
11. agenda_6 → слайд адженди з РІВНО 6 пунктами. ЗАГОЛОВОК="Адженда". ПУНКТ_1..ПУНКТ_6 = по одному індексу. Якщо пунктів не 6 — НЕ використовуй agenda_6.
