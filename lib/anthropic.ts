...
5. Перший слайд → cover. Останній → closing. ЗАГОЛОВОК closing-слайда = текст з останнього аркуша (наприклад «Дякуємо!»).
...
9. Якщо вхід розбитий на аркуші (=== Аркуш N ===):
   ...
   - Аркуш 1 → cover. Останній аркуш → closing (ЗАГОЛОВОК: null).
