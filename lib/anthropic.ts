...
5. Перший слайд → cover. Останній → closing. ЗАГОЛОВОК closing-слайда = перший рядок останнього аркуша. ПІДЗАГОЛОВОК = решта рядків через [i1, i2, ...] або null якщо є тільки один рядок.
...
9. Якщо вхід розбитий на аркуші (=== Аркуш N ===):
   ...
   - Аркуш 1 → cover. Останній аркуш → closing (ЗАГОЛОВОК: перший фрагмент аркуша, ПІДЗАГОЛОВОК: решта фрагментів через [i1,i2,...] або null).
...
- kpi_cards → набір метрик (2–4 картки). ЗНАЧЕННЯ = тільки число або одиниця ≤10 символів: «35», «2M+», «42%». ПІДПИС = що означає це число. ТЕКСТ ≤70 символів — субтитул, не абзац.
