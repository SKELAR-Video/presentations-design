...
- columns_flex → 2–4 паралельних пункти коли їх рівно 2–4 і жоден не є метрикою. Слоти: КОЛОНКА_1, КОЛОНКА_2, КОЛОНКА_3? (опціонально), КОЛОНКА_4? (опціонально). НІКОЛИ не використовуй КАРТКА_N для columns_flex.
...
- agenda_6 → слайд адженди або порядку денного з РІВНО 6 пунктами (timeline: 3 колонки × 2 рядки). ЗАГОЛОВОК = "Адженда". ПУНКТ_1..ПУНКТ_6 = стислий текст БЕЗ нумерації ("Текст пункту", НЕ "1. Текст пункту" — номери 01..06 відображаються автоматично). Ніколи не використовуй agenda_6 якщо пунктів не рівно 6.
- agenda_8 → слайд адженди з РІВНО 8 пунктами (timeline: 4 колонки × 2 рядки). Ті самі правила що agenda_6: ЗАГОЛОВОК = "Адженда", ПУНКТ_1..ПУНКТ_8 БЕЗ нумерації. Ніколи не використовуй agenda_8 якщо пунктів не рівно 8.
...
- **КОЛОНКА_N і КАРТКА_N — РІВНО ОДИН фрагмент кожен.** Ніколи не присвоюй масив [i, j, ...] у КОЛОНКА_N або КАРТКА_N. Якщо пунктів 4 і вони не є метриками — використовуй columns_flex (КОЛОНКА_1..4). Якщо пунктів 4 і всі є метриками — kpi_cards.
...
10. КОЛОНКА_N і КАРТКА_N — РІВНО ОДИН індекс кожен (ніколи масив). columns_flex → КОЛОНКА_1/2/3/4 (не КАРТКА_N). Якщо пунктів 4 і не метрики — columns_flex.
11. agenda_6 → слайд адженди з РІВНО 6 пунктами. ЗАГОЛОВОК="Адженда". ПУНКТ_1..ПУНКТ_6 = по одному індексу, текст БЕЗ нумерації (номери 01..06 автоматичні). Якщо пунктів не 6 — НЕ використовуй agenda_6.
12. agenda_8 → слайд адженди з РІВНО 8 пунктами. ЗАГОЛОВОК="Адженда". ПУНКТ_1..ПУНКТ_8 = по одному індексу, БЕЗ нумерації. Якщо пунктів не 8 — НЕ використовуй agenda_8.
