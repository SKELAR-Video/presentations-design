...
export const PHASE0_COMPOSITIONS: Composition[] = [
  ...
  },
  {
    ...
    when_to_use: 'слайд адженди або порядку денного з рівно 4 пунктами (timeline-дизайн: 2 колонки × 2 рядки). ЗАГОЛОВОК = "Адженда". ПУНКТ_1..4 = стислий текст кожного пункту БЕЗ нумерації.',
    themes: ['dark'],
    slots: [
      { name: 'ЗАГОЛОВОК', type: 'text', max_chars: 40, style: 'h1' },
      { name: 'ПУНКТ_1', type: 'text', max_chars: 80, style: 'body' },
